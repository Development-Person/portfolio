const data = [
  {
    ...
    date: 'November 2020',
    description:
      'Code along project to get me familiar with the MERN stack. Coded a working online store.',
    learnings: [
      'mongoDB',
      'React',
      'Redux',
  ...
  },
  {
    ...
    date: 'December 2020',
    description:
      'Used what I learnt in Proshop and created a major project working with react, redux, express and mongoDB. BorrowYours allows friends to lend each other household items.',
    learnings: [
      'mongoDB',
      'React',
      'Redux Toolkit',
  ...
  },
  {
    ...
    date: 'January 2021',
    description:
      'Working with sails, developed a backend utility to parse excel files and upload their contents to an SQL table',
    learnings: ['Sails', 'Express', 'Node', 'CSV file parsing', 'postgres/SQL'],
  ...
  },
  {
    ...
    date: 'February 2021',
    description:
      'Playing around with soundfiles using vanilla javascript and html',
    learnings: ['Audio API', 'HTML', 'CSS', 'Vanilla JS'],
